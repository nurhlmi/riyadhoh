...
export default function SholatSunnah() {
  const [sholat, setSholat] = useState([
    {
      title: 'Tahajjud (2 Rakaat)',
      progress: 0,
    },
    {
      title: 'Dhuha (2/4 Rakaat)',
      progress: 0,
    },
    {
      title: 'Tahiyyatul Masjid (2 Rakaat)',
      progress: 0,
    },
    {
      title: `Tarawih (8 Rakaat)`,
      progress: 0,
    },
    {
      title: `Witir (1/3 Rakaat)`,
      progress: 0,
    },
  ]);
    ...
    <Card>
      ...
      <CardContent sx={{ pr: 1.5, pb: '1rem!important' }}>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={1}>
          <Typography fontWeight="bold">Sholat Sunnah yang dianjurkan</Typography>
        </Stack>
