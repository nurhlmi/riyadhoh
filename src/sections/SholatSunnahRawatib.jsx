...
export default function SholatSunnahRawatib() {
  const [sholat, setSholat] = useState([
    {
      title: 'Qabliyah Subuh (2 Rakaat)',
      progress: 0,
    },
    {
      title: 'Qabliyah Dzuhur (4 Rakaat)',
      progress: 0,
    },
    {
      title: `Ba'diyah Dzuhur (2 Rakaat)`,
      progress: 0,
    },
    {
      title: `Ba'diyah Maghrib (2 Rakaat)`,
      progress: 0,
    },
    {
      title: `Ba'diyah Isya (2 Rakaat)`,
      progress: 0,
    },
  ]);
    ...
    <Card>
      ...
      <CardContent sx={{ pr: 1.5, pb: '1rem!important' }}>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={1}>
          <Typography fontWeight="bold">Sholat Sunnah Rawatib (Muakkad)</Typography>
        </Stack>
